...
I made a [firefox extension](https://github.com/Bigfootmech/Steam-Forgetmenot). Abandoned an early-stage [mod for Factorio](https://github.com/Bigfootmech/Factorio-Blueprint-Editor). And made some [small mods](https://steamcommunity.com/id/bigfootmech/myworkshopfiles/?appid=322330&sort=score&browsefilter=myfiles&view=imagewall) for Don't Starve Together about things that were bugging me in the game. The hardest thing being the display pictures for the mods, as I didn't want to use art I didn't have a license for - so drew everything myself.
